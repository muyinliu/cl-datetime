...
(subtest "Testing format-integer"
  (is (dt:format-integer nil 2017 4 4)
      "2017")
  (is (dt:format-integer nil 2017 3 4)
      "017")
  (is (dt:format-integer nil 2017 2 4)
      "17")
  (is (dt:format-integer nil 2017 1 4)
      "7")
  (is (dt:format-integer nil 357 1 3 :from-end nil)
      "3")
  (is (dt:format-integer nil 357 2 3 :from-end nil)
      "35")
  (is-error (dt:format-integer nil 2017 0 4)
            'error)
  (is-error (dt:format-integer nil 2017 5 4)
            'error))
